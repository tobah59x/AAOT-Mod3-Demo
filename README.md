# AAOT-Mod3-Demo
### Demo for Agentic AI Module 3 assignment
...
- The requirements.txt file lists the modules that need to be installed on your system before you run the code. This is also configured to run the Groq version of the code. To use another version of the code, check the requirements.txt file for the author (see the comment at the top of the code). To run this from the terminal window: ``pip install -r requirements.txt``
